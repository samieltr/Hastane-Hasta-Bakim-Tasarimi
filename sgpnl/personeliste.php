                    ...
                    <div class="content">
                        <div class="module">
						   ...
						   <div class="module">
							...
							<br>
							<p><a href="personelekle.php" class="btn btn-info">Yeni Personel Ekle</a></p>
...
while ($sonuc = $sorgu->fetch()) {
    ...
    <tr <?php echo $yon == 'sag' ? 'ml-auto' : 'mr-auto' ?>>
      ...
      <td><?= $sonuc['baslik'] ?></td>
	<td> 
	<a href="personelguncelle.php?id=<?= $sonuc["id"] ?>" class="btn btn-warning">Düzenle</a>
	<a href="inc/silpersonel.php?id=<?= $sonuc["id"] ?>" class="btn btn-danger">Sil</a></td>
