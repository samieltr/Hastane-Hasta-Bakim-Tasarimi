...
if ($_POST) { // Sayfada post olup olmadığını kontrol ediyoruz.
   ...
   $icerik = $_POST['icerik'];
            ...
            if (file_exists('images/' . $dosya_adi)) {
                ...
                if ($boyut > (1024 * 1024 * 2)) {
                    ...
                    if (!in_array($dosya_tipi, ['image/png', 'image/jpeg']) || !in_array($dosya_uzanti, ['png', 'jpg'])) {
                        ...
                        copy($foto, '../images/personel/' . $dosya_adi);
                        ...
                        $sql = "INSERT INTO personelist SET foto=:foto, ustBaslik=:ustBaslik,baslik=:baslik,icerik=:icerik;";
                        $durum = $baglanti->prepare($sql)->execute($satir);

                        if ($durum) {
                            echo  '<div class="alert alert-success" role="alert">Personel Başarıyla Eklendi.</div>';
                        }
    ...
    if($hata!=""){
		 echo '<div class="alert alert-danger" role="alert">Personel eklenemedi.</div> '.$hata.'';
    }
}
?>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="span9">
					...
					<form method="post" action="personelekle.php" enctype="multipart/form-data" class="form-horizontal row-fluid">
					<div class="control-group">
							...
							<div class="control-group">
											...
											<div class="controls">
												<input type="text" name="ustBaslik" id="ustBaslik" placeholder="Samet Erten" class="span8">
											</div>
										</div>
											...
											<div class="controls">
												<input type="text" name="baslik"  id="baslik" placeholder="Genel Başkan" class="span8">
											</div>
										</div>
