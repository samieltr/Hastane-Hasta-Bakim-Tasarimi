...
if ($_GET) {
    ...
    $durum = $baglanti->prepare("DELETE FROM musteri WHERE id=:id")->execute($where);
    if ($durum) {
        header("location:../musteriliste.php"); // Eğer sorgu çalışırsa index.php sayfasına gönderiyoruz.
    }
}
?>