...
if ($_GET) {
    ...
    $durum = $baglanti->prepare("DELETE FROM personelist WHERE id=:id")->execute($where);
    if ($durum) {
        header("location:../personeliste.php"); // Eğer sorgu çalışırsa index.php sayfasına gönderiyoruz.
    }
}
?>