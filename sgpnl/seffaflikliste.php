...
while ($sonuc = $sorgu->fetch()) {
    ...
    <tr <?php echo $yon == 'sag' ? 'ml-auto' : 'mr-auto' ?>>
      <td><?= $sonuc['kucukbaslik'] ?></td>
      <td><?= $sonuc['buyukbaslik'] ?></td>
	<td> 
	<a href="sayfaguncelle.php?id=<?= $sonuc["id"] ?>" class="btn btn-info">Düzenle</a>
	</td>
